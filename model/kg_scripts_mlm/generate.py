...
if __name__ == '__main__':
    ...
    parser.add_argument('--decoder_dir', default='weights/english/kg/covid_mlm/bestmodel.pth', type=str, required=False)
    parser.add_argument('--test_load_dir', default='../../preprocessed_data/kg_data_pointer/data_biobert/c_data_mlm/test_data.pkl', type=str, required=False)
    parser.add_argument('--pred_save_dir', default='Results/kg/covid_mlm/pred.txt', type=str, required=False)
    parser.add_argument('--reference_save_dir', default='Results/kg/covid_mlm/reference.txt', type=str, required=False)
    parser.add_argument('--metric_save_dir', default='Results/kg/covid_mlm/scores.txt', type=str, required=False)
    parser.add_argument('--output_save_dir', default='Results/kg/covid_mlm/Out.csv', type=str, required=False)
    ...
    for batch_id, batch in enumerate(test_dataloader):
        with torch.no_grad():
            ...
            encoder_input, decoder_input, mask_encoder_input, _, labels = batch
