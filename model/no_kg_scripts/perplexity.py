...
parser.add_argument('--load_dir', default='weights/english/no_kg/med/bestmodel.pth', type=str, required=False)
parser.add_argument('--validate_load_dir', default='../../preprocessed_data/data_biobert/data_biobert_med/validate_data.pkl', type=str, required=False)
...
parser.add_argument('--train_load_dir', default='../../preprocessed_data/data_biobert/data_biobert_med/train_data.pkl', type=str, required=False)
parser.add_argument('--save_dir', default='Results/no_kg/med/ppl.txt', type=str, required=False)
