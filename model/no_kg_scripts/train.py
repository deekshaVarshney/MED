...
if __name__ == '__main__':
    ...
    parser.add_argument('--validate_load_dir', default='../../preprocessed_data/data_biobert/data_biobert_med'
                                                       '/validate_data.pkl', type=str, required=False)
    parser.add_argument('--train_load_dir', default='../../preprocessed_data/data_biobert/data_biobert_med/train_data'
                                                    '.pkl', type=str, required=False)
