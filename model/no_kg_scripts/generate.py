...
if __name__ == '__main__':
    ...
    parser.add_argument('--test_load_dir', default='../../preprocessed_data/data_biobert/data_biobert_med/test_data.pkl', type=str, required=False)
    ...
    # tokenizer = AutoTokenizer.from_pretrained("weights/biobert_weight/biobert_v1.1_pubmed")
    tokenizer = AutoTokenizer.from_pretrained("weights/biobert_weight/dmis_biobert_large_case")
    ...
    # parser.add_argument('--top_k', default=50, type=int, required=False)
    # parser.add_argument('--temp', default=1.0, type=float, required=False)
    # parser.add_argument('--decoder_dir', default='weights/english/no_kg/med_rand/bestmodel.pth', type=str, required=False)
    # parser.add_argument('--test_load_dir', default='../../preprocessed_data/data_biobert/data_random_med/test_data.pkl', type=str, required=False)
    # parser.add_argument('--pred_save_dir', default='Results/kg_mlm/med_rand/pred.txt', type=str, required=False)
    # parser.add_argument('--reference_save_dir', default='Results/kg_mlm/med_rand/reference.txt', type=str, required=False)
    # parser.add_argument('--metric_save_dir', default='Results/kg_mlm/med_rand/scores.txt', type=str, required=False)
    # parser.add_argument('--output_save_dir', default='Results/kg_mlm/med_rand/Out.csv', type=str, required=False)
    # parser.add_argument('--hidden_size', default=768, type=int, required=False)
    # parser.add_argument('--vocab_size', default=28996, type=int, required=False)
    ...
    # parser.add_argument('--top_k', default=50, type=int, required=False)
    # parser.add_argument('--temp', default=1.0, type=float, required=False)
    # parser.add_argument('--decoder_dir', default='weights/english/no_kg/covid_fine/bestmodel.pth', type=str, required=False)
    # parser.add_argument('--test_load_dir', default='../../preprocessed_data/data_biobert/c_data/test_data.pkl', type=str, required=False)
    # parser.add_argument('--pred_save_dir', default='Results/kg_mlm/covid_fine/pred.txt', type=str, required=False)
    # parser.add_argument('--reference_save_dir', default='Results/kg_mlm/covid_fine/reference.txt', type=str, required=False)
    # parser.add_argument('--metric_save_dir', default='Results/kg_mlm/covid_fine/scores.txt', type=str, required=False)
    # parser.add_argument('--output_save_dir', default='Results/kg_mlm/covid_fine/Out.csv', type=str, required=False)
    # parser.add_argument('--hidden_size', default=768, type=int, required=False)
    # parser.add_argument('--vocab_size', default=28996, type=int, required=False)